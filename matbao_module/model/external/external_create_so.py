...
class ExternalCreateSO(models.AbstractModel):
    ...
    def create_order_lines(self, vals):
        ...
        required_arguments = [
            ...
            'ren_price_wot', 'ren_price_wt', 'ren_tax_amount', 'tax', 'sub_total', 'company_id']
    ...
    @api.model
    def create_so(self, name, coupon, date_order, saleteam_code, order_type, customer_code, company_id, status, lines=[]):
        """
        TO DO:
